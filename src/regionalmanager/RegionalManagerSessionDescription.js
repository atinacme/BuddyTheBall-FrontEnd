...
import { SafeAreaView, StyleSheet, Text, Alert, View, TextInput, Platform, Image, ScrollView, TouchableOpacity } from 'react-native';
            ...
            <SafeAreaView style={styles.wrapper}>
                <ScrollView style={styles.scrollView}>
                    ...
                    {route.params.scheduleData.coaches.map((v, i) => {
                        return <Text key={i} style={styles.label}>{v.coach_name}</Text>;
                    })}
