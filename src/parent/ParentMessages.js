...
export default function ParentMessages({ navigation }) {
        ...
        <LinearGradient colors={['#BCD7EF', '#D1E3AA', '#E3EE68', '#E1DA00']} style={styles.linearGradient}>
            <SafeAreaView style={styles.wrapper}>
                {senderMessages.map(item => {
                    return (
                        <TouchableOpacity key={item._id} onPress={() => navigation.navigate("Parent Particular Message", { messages: item })}>
                ...
                <TouchableOpacity onPress={() => navigation.navigate("Parent Message Creation")}>
