            ...
            <SafeAreaView style={styles.wrapper}>
                <ScrollView style={styles.scrollView}>
                    ...
                    <View style={styles.adminWrapper}>
                        <TouchableOpacity onPress={() => navigation.navigate("Customer Photos")}>
                            <Text style={{ ...styles.adminContainer, ...styles.adminBg1 }}>PHOTOS</Text>
                        </TouchableOpacity>
                        <TouchableOpacity onPress={() => navigation.navigate("Customer Messages")}>
                            <Text style={{ ...styles.adminContainer, ...styles.adminBg2 }}>MESSAGES</Text>
                        </TouchableOpacity>
                    </View>
