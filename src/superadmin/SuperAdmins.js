...
export default function SuperAdmins({ navigation }) {
        ...
        <LinearGradient colors={['#BCD7EF', '#D1E3AA', '#E3EE68', '#E1DA00']} style={styles.linearGradient}>
            <SafeAreaView style={styles.wrapper}>
                ...
                <View style={styles.adminbtn}>
                    <TouchableOpacity onPress={() => navigation.navigate("Super Admin Creation")}>
                        <Text style={styles.coach_cta}>Add New Super Admin</Text>
                    </TouchableOpacity>
