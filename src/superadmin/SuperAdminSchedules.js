...
export default function SuperAdminSchedules({ navigation }) {
        ...
        <LinearGradient colors={['#BCD7EF', '#D1E3AA', '#E3EE68', '#E1DA00']} style={styles.linearGradient}>
            <SafeAreaView style={styles.wrapper}>
                    ...
                    <View>
                        <DataTable style={styles.container}>
                            ...
                            {schedules.length > 0 && schedules.map(item => {
                                return (
                                    <TouchableOpacity key={item._id} onPress={() => navigation.navigate("SuperAdmin Schedule Description", { scheduleData: item })}>
                                        <DataTable.Row>
                                            {item.coaches.map(v => {
                ...
                <View style={styles.adminbtn}>
                    <TouchableOpacity onPress={() => navigation.navigate("SuperAdmin Schedule Creation")}>
