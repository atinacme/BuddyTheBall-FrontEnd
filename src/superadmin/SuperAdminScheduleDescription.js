...
import {
    SafeAreaView, StyleSheet, Text, Alert, View, TouchableOpacity, TextInput, Platform, Image, ScrollView
} from 'react-native';
import moment from 'moment';
import buddy from '../assets/buddy.png';
import LinearGradient from 'react-native-linear-gradient';
import DateTimePicker from '@react-native-community/datetimepicker';
import { DeleteScheduleService, UpdateScheduleService } from '../services/ScheduleService';

export default function SuperAdminScheduleDescription({ navigation, route }) {
