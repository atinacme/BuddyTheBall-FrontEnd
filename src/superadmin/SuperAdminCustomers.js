...
export default function SuperAdminCustomers({ navigation }) {
                ...
                <ScrollView horizontal>
                    <View>
                        <DataTable style={styles.container}>
                            ...
                            {customers.map(item => {
                                return (
                                    <TouchableOpacity key={item._id} onPress={() => navigation.navigate("SuperAdmin Customer Description", { customerData: item })}>
                                        <DataTable.Row>
